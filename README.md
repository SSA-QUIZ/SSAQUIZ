...
### 🌞 [UCC](https://www.youtube.com/watch?v=e4H6FFgY7a4)
...
- 선생님은 로그인을 통해 퀴즈 세트를 생성하고 관리할 수 있습니다.
  

### 정보수정

![정보수정](README.assets/정보수정.gif)

- 회원 정보를 수정할 수 있습니다.
- 회원 프로필 사진도 바꿀 수 있습니다.
  

### 문제수정

![문제수정](README.assets/문제수정.gif)

- 생성한 퀴즈는 모든 항목의 수정이 가능합니다.
  

### 퀴즈 생성

![퀴즈생성](README.assets/퀴즈생성.gif)

- 사지선다, 단답형, T/F, 순서 맞추기 중 선택할 수 있습니다.
- 제한시간과 점수 배점을 선택할 수 있습니다.



### 퀴즈진행

![퀴즈진행](README.assets/퀴즈진행.gif)

- 왼쪽은 선생님의 화면, 오른쪽은 학생의 모바일 화면입니다.
- 선생님과 학생은 실시간으로 참여 학생을 볼 수 있습니다.
- 응답 수와 남은 시간을 보여줍니다.
- 중간점검과 최종 결과를 실시간으로 보여줍니다.
